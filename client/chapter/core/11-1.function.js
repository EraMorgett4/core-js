...
//getComputedStyle : html에 있는 스타일을 긁어올 수 있음. 그냥 first.style.color를 선택하면 사용자가 임의로 지정한 'blue'가 선택되어버림.
//때문에 get ComputedStyle(first)['color'] 등으로 지정해야한다.
...
getStyle('.first', 'color');

/*
함수 만드는 순서
1. 함수 이름 설정
2. argument (함수 실행부) 설정
3. 매개변수 설정
4. return 값 설정
5. validation 확인
